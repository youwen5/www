    ...
    , body =
        map toUnstyled
            [ div [ css [ maxWidth (px 800), marginLeft auto, marginRight auto ] ]
                ...
                , h2 [] [ text "fall 2024" ]
                , ul []
                    [ li [] [ text "math4a - fake linear algebra for dummies" ]
                    ]
                , h2 [] [ text "winter 2025" ]
                , ul []
                    [ li [] [ text "math4b - ordinary differential equations" ]
                    , li [] [ text "math6a - vector calculus, first course" ]
                    , li [] [ text "math8 - discrete math / intro to proofs" ]
                    , li [] [ text "pstat120a - probability theory" ]
                    , li [] [ text "cs16 - problem solving with c++" ]
                    ]
                , h2 [] [ text "spring 2025" ]
                , ul []
